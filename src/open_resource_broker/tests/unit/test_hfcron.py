...
from open_resource_broker.cli.hf import run as hostfactory
...
@mock.patch("open_resource_broker.hfcron.RefreshPodsTask")
@mock.patch("open_resource_broker.hfcron.RefreshNodesTask")
