...
The :class:`KubernetesTemplateExtensionConfig` is registered with
...
class KubernetesTemplateExtensionConfig(BaseModel):
    """Kubernetes-specific template extension configuration.
    ...
    :class:`KubernetesProviderConfig` defaults.  Operator-level overrides
    ...
    namespace: Optional[str] = Field(
        ...
        description=(
            ...
            "``KubernetesProviderConfig.namespace`` when unset."
        ),
    )
    ...
    image_pull_secret: Optional[str] = Field(
        ...
        description=(
            ...
            "Falls back to ``KubernetesProviderConfig.default_image_pull_secret`` when unset."
        ),
    )
