...
Populated by :class:`~orb.providers.kubernetes.watch.watcher.KubernetesWatcher`
and consumed by
:class:`~orb.providers.kubernetes.handlers.pod_handler.KubernetesPodHandler`
...
class PodState:
    ...
    :meth:`KubernetesPodHandler._instance_dict_for_pod`.
    """
