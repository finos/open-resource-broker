...
:class:`~orb.providers.kubernetes.watch.pod_state_cache.PodState` and
...
:mod:`~orb.providers.kubernetes.watch.multi_namespace`.
"""
...
class KubernetesWatcher:
    ...
    def _pod_to_state(
        ...
        *,
        ...
        Mirrors :meth:`KubernetesPodHandler._instance_dict_for_pod` so
...
# ---------------------------------------------------------------------------
# Status mapping helpers — duplicated from KubernetesPodHandler so the
...
def _pod_status_string(phase: Optional[str], ready: bool) -> str:
    """Mirror of :meth:`KubernetesPodHandler._pod_status_string`."""
    if phase == "Running":
...
def _extract_status_reason(
    ...
    """Mirror of :meth:`KubernetesPodHandler._extract_status_reason`."""
...
__all__ = ["KubernetesWatcher", "WatchFactory"]
