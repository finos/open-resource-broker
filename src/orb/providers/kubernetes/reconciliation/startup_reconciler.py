...
and is governed by :attr:`KubernetesProviderConfig.auto_cleanup_orphans`.
"""
...
class StartupReconciler:
    ...
    in :class:`KubernetesProviderStrategy` is straightforward.
    """
...
# ---------------------------------------------------------------------------
#
# Mirrors :meth:`KubernetesWatcher._pod_to_state` exactly so the
