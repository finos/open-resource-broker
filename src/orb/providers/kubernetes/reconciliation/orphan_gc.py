...
Behaviour is governed by :attr:`KubernetesProviderConfig.auto_cleanup_orphans`:
...
The task is opt-in via :attr:`KubernetesProviderConfig.orphan_gc_enabled`
...
from orb.providers.kubernetes.reconciliation.startup_reconciler import OrphanPod
...
class OrphanGarbageCollector:
    ...
    Args:
        ...
        interval_seconds: Override for
            :attr:`KubernetesProviderConfig.orphan_gc_interval_seconds`
    ...
    def start(self) -> None:
        ...
        :attr:`KubernetesProviderConfig.orphan_gc_enabled`; this method
