"""Azure spot placement score planning service."""
...
class PlacementSplitStrategy(str, Enum):
    """How to split requested capacity across spot placement candidates."""
...
class PlacementCandidate:
    """Azure spot placement candidate."""
...
class SpotPlacementPlanner:
    ...
    def _create_greedy_plan(
        ...
        return [
            PlacementPlanEntry(score=scores[0], planned_count=requested_count),
            *[PlacementPlanEntry(score=score, planned_count=0) for score in scores[1:]],
        ]
