    ...
    try:
        ...
        def _build_stats_line(snap: WatchRequestStatusOutput) -> RichText:
            ...
            if snap.weighted:
                ...
                line.append("  ")
                line.append(f"OnDmnd:{snap.od_capacity} units", style="bold bright_green")
                line.append(" ")
                line.append(f"Spot:{snap.spot_capacity} units", style="bold #ffdb47")
            else:
                line.append(f"{snap.fulfilled_count}/{total} machines", style="bold #4c7aa7")
                line.append("  ")
                line.append(f"OnDmnd:{snap.od_machines} machines", style="bold bright_green")
                line.append(" ")
                line.append(f"Spot:{snap.spot_machines} machines", style="bold #ffdb47")
            line.append("  ")
