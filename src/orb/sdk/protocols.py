...
class ORBClientProtocol(Protocol):
    ...
    # --- Template operations ---
    async def get_template(self, *, template_id: str, **kwargs: Any) -> dict[str, Any]:  # type: ignore[return]
        pass
    ...
    async def validate_template(self, *, template_id: str, **kwargs: Any) -> dict[str, Any]:  # type: ignore[return]
        pass
    ...
    async def list_requests(self, **kwargs: Any) -> list[dict[str, Any]]:  # type: ignore[return]
        pass

    async def list_return_requests(self, **kwargs: Any) -> list[dict[str, Any]]:  # type: ignore[return]
        pass

    async def list_active_requests(self, **kwargs: Any) -> list[dict[str, Any]]:  # type: ignore[return]
        pass

    async def get_request_summary(self, *, request_id: str, **kwargs: Any) -> dict[str, Any]:  # type: ignore[return]
        pass
    ...
    # --- Machine operations ---
    async def get_machine(self, *, machine_id: str, **kwargs: Any) -> dict[str, Any]:  # type: ignore[return]
        pass

    async def list_machines(self, **kwargs: Any) -> list[dict[str, Any]]:  # type: ignore[return]
        pass

    async def get_active_machine_count(self, **kwargs: Any) -> dict[str, Any]:  # type: ignore[return]
        pass

    async def get_machine_health(self, **kwargs: Any) -> dict[str, Any]:  # type: ignore[return]
        pass
    ...
    # --- Provider operations ---
    async def get_provider_health(self, **kwargs: Any) -> dict[str, Any]:  # type: ignore[return]
        pass

    async def list_available_providers(self, **kwargs: Any) -> list[dict[str, Any]]:  # type: ignore[return]
        pass

    async def get_provider_capabilities(self, **kwargs: Any) -> dict[str, Any]:  # type: ignore[return]
        pass

    async def get_provider_metrics(self, **kwargs: Any) -> dict[str, Any]:  # type: ignore[return]
        pass

    async def get_provider_strategy_config(self, **kwargs: Any) -> dict[str, Any]:  # type: ignore[return]
        pass
    ...
    async def cleanup_all_resources(self, **kwargs: Any) -> dict[str, Any]:  # type: ignore[return]
        pass

    # --- Storage operations ---
    async def list_storage_strategies(self, **kwargs: Any) -> list[dict[str, Any]]:  # type: ignore[return]
        pass

    async def get_storage_health(self, **kwargs: Any) -> dict[str, Any]:  # type: ignore[return]
        pass

    async def get_storage_metrics(self, **kwargs: Any) -> dict[str, Any]:  # type: ignore[return]
        pass

    # --- Scheduler operations ---
    async def list_scheduler_strategies(self, **kwargs: Any) -> list[dict[str, Any]]:  # type: ignore[return]
        pass

    async def get_scheduler_configuration(self, **kwargs: Any) -> dict[str, Any]:  # type: ignore[return]
        pass

    async def validate_scheduler_configuration(self, **kwargs: Any) -> dict[str, Any]:  # type: ignore[return]
        pass

    # --- System / config operations ---
    async def get_configuration_section(self, *, section: str, **kwargs: Any) -> dict[str, Any]:  # type: ignore[return]
        pass

    async def get_provider_config(self, **kwargs: Any) -> dict[str, Any]:  # type: ignore[return]
        pass

    async def validate_provider_config(self, **kwargs: Any) -> dict[str, Any]:  # type: ignore[return]
        pass

    async def get_system_status(self, **kwargs: Any) -> dict[str, Any]:  # type: ignore[return]
        pass

    async def validate_storage(self, **kwargs: Any) -> dict[str, Any]:  # type: ignore[return]
        pass

    async def validate_mcp(self, **kwargs: Any) -> dict[str, Any]:  # type: ignore[return]
        pass
