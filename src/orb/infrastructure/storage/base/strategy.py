...
class StorageStrategy(StoragePort[T], ABC, Generic[T]):
    ...
    def cleanup(self) -> None:
        ...
        Raises:
            StorageError: If there's an error cleaning up resources
        """
    ...
    def save(self, entity_id: str, data: dict[str, Any]) -> None:  # type: ignore[override]
        ...
        Raises:
            StorageError: If there's an error saving the entity
        """
    ...
    def delete(self, entity_id: str) -> None:
        ...
        Raises:
            StorageError: If there's an error deleting the entity
        """
    ...
    def begin_transaction(self) -> None:
        ...
        Raises:
            StorageError: If there's an error beginning the transaction
        """
    ...
    def commit_transaction(self) -> None:
        ...
        Raises:
            StorageError: If there's an error committing the transaction
        """
    ...
    def rollback_transaction(self) -> None:
        ...
        Raises:
            StorageError: If there's an error rolling back the transaction
        """
    ...
    def save_batch(self, entities: dict[str, dict[str, Any]]) -> None:
        ...
        Raises:
            StorageError: If there's an error saving the entities
        """
    ...
    def delete_batch(self, entity_ids: list[str]) -> None:
        ...
        Raises:
            StorageError: If there's an error deleting the entities
        """
...
class BaseStorageStrategy(StorageStrategy[T], Generic[T]):
    ...
    def __enter__(self) -> "StorageStrategy[T]":
        ...
        """
        if self._is_closed:
            raise StorageError("Cannot enter context with closed storage strategy")
        return self
    ...
    def begin_transaction(self) -> None:
        ...
        try:
            ...
            raise StorageError(f"Error beginning transaction: {e!s}")
    ...
    def commit_transaction(self) -> None:
        ...
        try:
            ...
            raise StorageError(f"Error committing transaction: {e!s}")
    ...
    def rollback_transaction(self) -> None:
        ...
        try:
            ...
            raise StorageError(f"Error rolling back transaction: {e!s}")
    ...
    def save_batch(self, entities: dict[str, dict[str, Any]]) -> None:
        ...
        try:
            ...
            raise StorageError(f"Error saving batch: {e!s}")
    ...
    def delete_batch(self, entity_ids: list[str]) -> None:
        ...
        try:
            ...
            raise StorageError(f"Error deleting batch: {e!s}")
